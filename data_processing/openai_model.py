    ...
    if model == "gpt-3.5-turbo":
        completion = client.chat.completions.create(
            ...
            messages=[
                {
                    "role": "system",
                    "content": "You are a researcher skilled in reading news articles to identify the ones about fatal police shooting incidents.",
                },
