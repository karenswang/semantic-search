...
values = [["Title", "Snippet", "URL"]] + [  # Headers or column names
    [item["title"], item["snippet"], item["link"]] for item in res["items"]  # Data rows
]
...
sheet_range = (
    "Sheet1!A1"  # This points to the top-left cell of your Sheet, adjust as needed
)
